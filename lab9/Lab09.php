    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
            ...
            foreach ($countries as $current) {
                echo "<a href='list.php?country=$current'" . "role='button' class='btn btn-default'>" . $current . "</a>";
            }
        ...
        <ul class="caption-style-2">
            ...
            foreach ($images as $current) {
                echo "<li>";
                echo "<a href='detail.php?id={$current['id']}'" . " class='img-responsive'>";
                echo "<img src='images/square/{$current['path']}' alt='{$current['title']}'>";
